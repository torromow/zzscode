package com.weinxin.main;

import com.course.menu.*;
import com.course.pojo.Token;
...
public class MenuManager {
	...
	private static Menu getMenu() {
		...
		btn10.setName("码云");
		btn10.setType("view");
		btn10.setUrl("https://gitee.com/explore/recommend");
		...
		mainBtn1.setSub_button(new Button[] {btn10, btn11, btn12, btn13 });
	...
	public static void main(String[] args) {
		// 第三方用户唯一凭证
		String appId = "wxb84154ec973ae4f2";
		// 第三方用户唯一凭证密钥
		String appSecret = "5c75f2f19467ed0ab26c46798fdb74d8";
		...
		if (null != token) {
			...
			String queryresult=MenuUtil.getMenu(token.getAccessToken());
